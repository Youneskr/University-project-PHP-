<?php 
	...
	if(isset($_POST['create']))
	{
        ...
        //test niveau et filliére
		if(empty($Niveau) && !empty($Fil) ){ $erreurs ['Niveau_Fil'] = "Veuillez saisir le niveau"; }
		elseif(empty($Fil) && !empty($Niveau) ){ $erreurs ['Niveau_Fil'] = "Veuillez saisir la filliére"; }
        elseif(empty($Fil) && empty($Niveau)){$erreurs ['Niveau_Fil'] = "Veuillez saisir le niveau et la filliére";}
		...
		if (!array_filter($erreurs)) {
			...
			$sql = "INSERT INTO users (CIN, Nom, Prenom, Niveau, Fil, Email, Login, Password) 
					VALUES ('$CIN','$Nom','$Prenom','$Niveau','$Fil','$Email','$Login','$Password')";
			if(!mysqli_query($db , $sql)){
				$msg_f = "Echec : Impossible d'ajouter l'étudiant";
			}
    ...
    <div class="links d-none d-md-block">
        <nav class="navbar">
            ...
            <li class="nav-item rounded-pill"><a class="nav-link" href="dashboard.php"><i class="fa-solid fa-chart-line"></i> Dashboard</a></li>
                ...
                <li class="nav-item rounded-pill active"><a class="nav-link" href="etudiant.php"><i class="fa-solid fa-user-plus"></i> étudiant</a></li>
        ...
        <div class="container">
            <div class="row formaulaire d-flex justify-content-between align-items-center rounded">
                    <div class="col-12 col-lg-7">
                        <form class="p-2" action="etudiant.php" method="POST">
                            <!-- Nom et prenom -->
                            ...
                            <div class="input-group ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Niveau et Filliére</span>
                                </div>
                                <input value="<?php echo $Niveau ; ?>" type="text" name="Niveau" id="Niveau" class="form-control" placeholder="Niveau">
                                <input value="<?php echo $Fil ; ?>" type="text" name="Fil" id="Fil" class="form-control" placeholder="Filiére">
                            </div>
                            <div class="form-text erreur mb-2"><?php echo $erreurs ['Niveau_Fil']; ?></div>
                            <!-- Niveau et Filliére -->
                            ...
                            <div class="input-group">
                                ...
                                <input value="<?php echo $Email ; ?>" type="text" name="Email" id="Email" class="form-control" placeholder="etudiant@isitcom.tn">
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input value="<?php echo $Login ; ?>" type="text" name="Login" id="Login" class="form-control" placeholder="etudiant123">
                            </div>
