...
if(isset($_POST['appliquer'])){
    ...
    if( mysqli_num_rows($social_media)<1){
        $sql = "INSERT INTO social_media (facebook, instagram, twitter,id_auth	) 
        VALUES ('$facebook','$instagram','$twitter','$id')";
        mysqli_query($db , $sql);
        header('Location:profil.php');
    }
    else{
        $sql = "UPDATE social_media SET `facebook`='$facebook',`instagram`='$instagram',`twitter`='$twitter' WHERE id_auth	='$id' " ;
        mysqli_query($db , $sql);
        header('Location:profil.php');
    }
}
                    ...
                    <form action="social_media.php" method="POST">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <input name="facebook" type="text" class="w-50 form-control" value="<?php if(isset($links['facebook'])){echo $links['facebook'];}?>">
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram mr-2 icon-inline text-danger"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>Instagram</h6>
                                <input name="instagram" type="text" class="w-50 form-control" value="<?php if(isset($links['instagram'])){echo $links['instagram'];}?>">
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter mr-2 icon-inline text-info"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>Twitter</h6>
                                <input name="twitter" type="text" class="w-50 form-control" value="<?php if(isset($links['twitter'])){echo $links['twitter'];}?>">
                            </li>
                        </ul>
                        <input name="appliquer" class="mt-3 mx-auto btn btn-warning" type="submit" value="Appliquer">
